                  ...
                  <div className="space-y-3 max-h-[350px] overflow-y-auto pr-1">
                    {todayNotifications.length === 0 ? (
                      ...
                      todayNotifications.map(n => (
                        <div key={n.id} className="p-3 bg-rose-50 border border-rose-100 rounded-lg text-xs space-y-1 animate-in fade-in">
              ...
              <div className="space-y-6 max-h-[500px] overflow-y-auto pr-1">
                {Object.keys(groupedNotifications).length === 0 ? (
                  ...
                  Object.keys(groupedNotifications).map(dateStr => (
                    <div key={dateStr} className="space-y-3 animate-in fade-in">
